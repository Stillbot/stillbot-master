...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wash.ending_ph'
        db.add_column(u'brew_master_wash', 'ending_ph',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wash.ending_ph'
        db.delete_column(u'brew_master_wash', 'ending_ph')
    ...
    models = {
        ...
        u'brew_master.wash': {
            ...
            'ending_ph': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
