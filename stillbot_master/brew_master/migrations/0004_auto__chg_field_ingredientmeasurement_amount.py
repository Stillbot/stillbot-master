...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IngredientMeasurement.amount'
        db.alter_column(u'brew_master_ingredientmeasurement', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'IngredientMeasurement.amount'
        db.alter_column(u'brew_master_ingredientmeasurement', 'amount', self.gf('django.db.models.fields.IntegerField')())
