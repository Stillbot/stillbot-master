...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Wash.ended_sg'
        db.alter_column(u'brew_master_wash', 'ended_sg', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2))

        # Changing field 'Wash.starting_sg'
        db.alter_column(u'brew_master_wash', 'starting_sg', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Wash.ended_sg'
        db.alter_column(u'brew_master_wash', 'ended_sg', self.gf('django.db.models.fields.DecimalField')(default='', max_digits=4, decimal_places=2))

        # Changing field 'Wash.starting_sg'
        db.alter_column(u'brew_master_wash', 'starting_sg', self.gf('django.db.models.fields.DecimalField')(default='', max_digits=4, decimal_places=2))
