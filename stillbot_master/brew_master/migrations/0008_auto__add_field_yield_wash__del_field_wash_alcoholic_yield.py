...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Yield.wash'
        db.add_column(u'brew_master_yield', 'wash',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='yield', null=True, to=orm['brew_master.Wash']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Yield.wash'
        db.delete_column(u'brew_master_yield', 'wash_id')
